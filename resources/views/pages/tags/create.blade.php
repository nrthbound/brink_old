  ...
  <div class="bg-white w-full shadow p-4">
    <form method="POST">
      ...
      <div class="block mb-4">
        ...
        <input type="text" id="name" autofocus class="block px-2 py-3 bg-input text-grey-medium rounded w-full {{ $errors->has('name') ? 'bg-error' : 'bg-grey-light' }}" value="{{ old('name') }}" name="name" />
      </div>
